...
import com.miappsoft.biblioteca.Editoriales.Listar_Editoriales
...
class MenuResenas : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_ActivityAgregarReseñas.setOnClickListener {
            ...
            val intent = Intent(this, AgregarResena::class.java).apply {
        ...
        btn_ActivityLeerReseñas.setOnClickListener {
            val intent = Intent(this, Listar_Resenas::class.java)
            startActivity(intent)
        }
